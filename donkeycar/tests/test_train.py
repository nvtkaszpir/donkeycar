...
def test_train_TrainTestSplit_simple(tub_path):
    ...
    print()
    print(
        "Testing a {} Test-Train split...".format(opts["cfg"].TRAIN_TEST_SPLIT)
    )
    print()
...
def test_train_TrainTestSplit_continuous(tub_path):
    ...
    print()
    print(
        "Initial split of {} records to {} Test-Train split...".format(
    ...
    print()
    print(
        "Added an extra {} records, aiming for overall {} Test-Train split...".format(
            additional_records, opts["cfg"].TRAIN_TEST_SPLIT
        )
    )
    print()
