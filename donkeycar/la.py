...
class Quat(object):
    ...
    def slerp(self, tval, low, high):
        lHigh = Quat()
        cosom = (
            low.x * high.x + low.y * high.y + low.z * high.z + low.w * high.w
        )
        if cosom < 0.0:
            cosom = -cosom
            lHigh.x = -high.x
...
class Mat44(object):
    ...
    def inverse(self):
        ...
        inv.d.x = -(
            self.d.x * inv.a.x + self.d.y * inv.b.x + self.d.z * inv.c.x
        )
        inv.d.y = -(
            self.d.x * inv.a.y + self.d.y * inv.b.y + self.d.z * inv.c.y
        )
        inv.d.z = -(
            self.d.x * inv.a.z + self.d.y * inv.b.z + self.d.z * inv.c.z
        )
