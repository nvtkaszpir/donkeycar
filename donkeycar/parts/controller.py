...
class RC3ChanJoystick(Joystick):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.button_names = {0x120: "Switch-up", 0x121: "Switch-down"}

        self.axis_names = {0x1: "Throttle", 0x0: "Steering"}
...
class JoystickController(object):
    ...
    def update(self):
        ...
        while self.running:
            ...
            if (
                button
                and button_state >= 1
                and button in self.button_down_trigger_map
            ):
                """
            ...
            if (
                button
                and button_state == 0
                and button in self.button_up_trigger_map
            ):
                """
                then invoke the function attached to that button
                """
    ...
    def run(self, img_arr=None):
        raise Exception(
            "We expect for this part to be run with the threaded=True argument."
        )
