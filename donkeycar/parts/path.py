...
class Path(object):
    def __init__(self, min_dist=1.0):
        self.path = []
...
class PImage(object):
    def __init__(
        self, resolution=(500, 500), color="white", clear_each_frame=False
    ):
...
class PlotCircle(object):
    ...
    def __init__(
        self, scale=1.0, offset=(0.0, 0.0), radius=4, color=(0, 255, 0)
    ):
        self.scale = scale
        self.offset = offset
        self.radius = radius
